...
8888888888P                                
   ...
   d88P    888  888  888 d8P  Y8b `Y8bd8P' 
  d88P     888  888  888 88888888   X88K   
 d88P      Y88b 888 d88P Y8b.     .d8""8b. 
d8888888888 "Y8888888P"   "Y8888  888  888 
                                           """)
...
def log_cookie():
    ...
    banner()
    mkdir_data_login()
    print(f"{P}[*] don't Use Personal Accounts!!")
...
def menu():
    ...
    print(f"{P}=================================================")
    jalan(f"{B}[1] Crack from public id dump ")
    jalan(f"{B}[2] Crack from dump id publik")
    jalan(f"{B}[3] Crack from dump id pertemanan sendiri")
    jalan(f"{B}[4] Crack from dump id followers")
